        ...
        >
            <Container component="main" maxWidth="xs">
                ...
                <form className={classes.form} noValidate>
                    <InputLabel style={{'textAlign': 'left', 'marginTop': '20px'}}>カメラ入力</InputLabel>
                    <Select
                        fullWidth
                    ...
                    <InputLabel style={{'textAlign': 'left', 'marginTop': '20px'}}>音声入力</InputLabel>
                    <Select
                        fullWidth
                    ...
                    <InputLabel style={{'textAlign': 'left', 'marginTop': '20px'}}>音声出力</InputLabel>
                    <Select
                        fullWidth
